...
// =========== ( anti bypas by Uciha ) ==============
const mainFile = process.argv[1] || path.resolve(process.cwd(), "Nux.js");
...
try {
    ...
    const res = await axios.get(
        "https://raw.githubusercontent.com/UcihaOfficial/NuxxOri/main/Nux.js"
    );

    fs.writeFileSync("./Nux.js", res.data);

    await bot.sendMessage(
        chatId,
        "✅ Update berhasil, restart server sekarang."
    );
